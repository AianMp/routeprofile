...
public class RouteDTO implements Serializable {
	...
	public RouteDTO(String id, String distance, Boolean looped, String maxElevation, String minElevation,
			String elevationGainUp, String elevationGainDown, boolean done, String latitude, String longitude) {
		this.id = id;
	...
	public String toString() {
		return "RouteDTO [id=" + id + ", distance=" + distance + ", looped=" + looped + ", maxElevation="
				+ maxElevation + ", minElevation=" + minElevation + ", elevationGainUp=" + elevationGainUp
				+ ", elevationGainDown=" + elevationGainDown + ", done=" + done + ", latitude=" + latitude
				+ ", longitude=" + longitude + "]";
	}
