...
public class UserDTO implements Serializable {
    ...
    private Collection<String> routeIds = new ArrayList<String>();
	...
	if (!this.getRouteIds().contains(id)) {
	    Collection<String> newRouteIds = new ArrayList<String>();
	    newRouteIds.addAll(this.getRouteIds());
	    newRouteIds.add(id);
	    this.setRouteIds(newRouteIds);
	}
    }
